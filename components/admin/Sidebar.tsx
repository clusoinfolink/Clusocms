...
import {
  ...
  Briefcase, MessageSquare, Settings, Star, Bell, UserPlus, BriefcaseBusiness, ShieldCheck,
} from 'lucide-react';
...
const links = [
  ...
  { href: '/dashboard/verification-logs', label: 'Verification Logs', icon: ShieldCheck },
